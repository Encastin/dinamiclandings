                ...
                <form id="formulario" class="row g-3" action="guardar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="hv1" id="nomhv1bre" placeholder="Introducir hipervínculo 1">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label tituloimput">Color de título</label>
                        <input type="color" class="form-control form-control-color" name="colorT3" id="colorT3" value="#F1F1F1" title="Elegir color">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="fa-solid fa-t"></i>
